...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`ABC Financial Services System`}</title>

        <meta
          name="description"
          content="Experience a new era of banking with ABC Financial Services System - Your comprehensive solution for financial advice, insurance policies, NPS, and more."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`ABC Financial Services System`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Experience a new era of banking with ABC Financial Services System - Your comprehensive solution for financial advice, insurance policies, NPS, and more.`}
            </Text>
            <Box
            ...
            >
              <Stack direction={{ md: 'row', base: 'column' }} spacing="1.5rem">
                <Card userTypeName="Financial Advisor" type="financial-advisor" abilities={appConfig.ownerAbilities} />
